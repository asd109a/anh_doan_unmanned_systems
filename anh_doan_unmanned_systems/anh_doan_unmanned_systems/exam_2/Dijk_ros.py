...
def djikstras(start_x:int, start_y:int, min_x:int, min_y:int, max_x:int,max_y:int, 
          obstacle_positions:list, gs :float, obstacle_radius:float,goal_x:float,goal_y:float,obstacle_list:list)-> list:
